...
public class SpeechService extends Service {
        ...
        mRequestObserver.onNext(StreamingRecognizeRequest.newBuilder()
                .setStreamingConfig(StreamingRecognitionConfig.newBuilder()
                        .setConfig(RecognitionConfig.newBuilder()
                                .setLanguageCode(Commons.lang.equals("en")? "en-US": Commons.lang.equals("ro")? "ro-RO" : Commons.lang.equals("sv")? "sv-SE" : getDefaultLanguageCode())
    ...
    private class AccessTokenTask extends AsyncTask<Void, Void, AccessToken> {
        ...
        protected AccessToken doInBackground(Void... voids) {
            ...
            // *******************
            final InputStream stream = getResources().openRawResource(R.raw.voxmed_1571122162470_3701d19ad2bf);
            try {
